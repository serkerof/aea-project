...
const Profit = () => {
  return (
    <div className={`${styles.container}`}>
      ...
      <section className={`${styles.paragraph_section} ${styles.txt_green}`}>
      ...
      <section className={`${styles.paragraph_section}  ${styles.txt_aqua}`}>
        <h4 className={`${styles.topic_title}`}>Wertvolle Dienst </h4>
        <p className={`${styles.topic_desc}`}>
          Mit hohem verantwortungsvoll werden wir uns um von Ihnen beauftragte
          Dienstleistung kümmern
        </p>
      </section>
      <section className={`${styles.paragraph_section} ${styles.txt_yellow}`}>
        <h4 className={`${styles.topic_title}`}>Schnell</h4>
        <p className={`${styles.topic_desc}`}>
          Sie werden sehr schnell behandelt und ein Besuchtermin kriegen
        </p>
      </section>
      <section className={`${styles.paragraph_section}  ${styles.txt_purple}`}>
